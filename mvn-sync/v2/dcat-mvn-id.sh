...
dcat-mvn-id() {
  ...
  # TODO The metadata file must be a file pattern because it can carry qualifiers such as
  # maven-metadata-local.xml or maven-metadata-myrepo.xml
  metaName='maven-metadata-local.xml'
