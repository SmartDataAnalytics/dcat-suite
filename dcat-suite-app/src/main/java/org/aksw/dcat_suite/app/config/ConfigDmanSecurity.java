...
public class ConfigDmanSecurity extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        ...
        http
            ...
            .csrf().disable().requestCache().requestCache(new CustomRequestCache())

            // Allow all flow internal requests.
            .and().authorizeRequests().requestMatchers(VaadinSecurityUtils::isFrameworkInternalRequest).permitAll()
